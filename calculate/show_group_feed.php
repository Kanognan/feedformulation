...
<head>
    ...
    <title>ผลลัพธ์การคำนวณโภชนะโคแบบรายกลุ่ม</title>
...
if (isset ($_POST['calproductgroup'])) {
    ...
    WHERE cow.acc_id = $acc_id AND group_cow.group_id = '$gid'
    GROUP BY cow_gender");
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Fetch data from the result set
            ...
            // ย้ายตรวจสอบและกำหนดค่าไปยังภายในลูป while
            $dominant_gender = ($femaleCount > $maleCount) ? 'เพศเมีย' : 'เพศผู้';
            $cow_gender = $dominant_gender;
            $cow_activity = $row['cow_activity'];
            $cow_breed_status = $row['cow_breed_status'];
            $cow_milk_status = $row['cow_milk_status'];
            $calf_date = $row['avg_calf_date'];
            $milk_date = $row['avg_milk_date'];

        


    }
    $group = mysqli_query($conn, "select * from group_cow WHERE group_id = '$gid'");
    $qg = mysqli_fetch_assoc($group);
    if (!$qg) {
        die ("การเรียกใช้ mysqli_fetch_assoc() ล้มเหลว: " . mysqli_error($conn));
    }
    ...
    // ---------------------------------------------------------------------------------------------------
    // ค่า NE
    $NEm = (85 / 1000 * pow($cow_weight, 0.75));
    ?>
    ...
    <body>
        <div class="flex">
            ...
            <div class="g-2">
                <div class="content">
                    <h2 class="text-center">ผลลัพธ์การคำนวณโภชนะโคแบบรายกลุ่ม</h2>
                    <form action="addproductgroup.php?group_id=<?php echo $gid; ?>" method="post">
                        <div class="t1-1 was-validated">
                            ...
                            <input type="text" class="form-control" id="dem_name" name="dem_name"
                                placeholder="กรอกชื่อรายการคำนวณโภชนะ" required pattern="[^' '][a-zA-Zก-๙0-9]+">
                        </div>
                        <div class="t1-1">
                            <div class="row">
                                <div class="col-6">
                                    <div class="edible">
                                        ...
                                        <div class="content-edible">
                                            <p>
                                                <?php echo "<b>ชื่อกลุ่ม : </b>" . $qg['group_name'], "<b>เพศ : </b>" . $dominant_gender, '<br>'; ?>
                                            </p>
                                            <p>
                                                <?php echo "<b>ค่าเฉลี่ยน้ำหนัก : </b>", number_format($cow_weight, 2, '.', ''); ?>
                                                กิโลกรัม
                                            </p>
                                            <p>
                                                <?php echo '<b>ค่าเฉลี่ยอายุ : </b>' . $avgAge;
                                                '<br>'; ?>
                                            </p>
                                            <p>
                                                <?php echo ' <b>รุ่น : </b>' . $avg_gen ?>
                                            </p>
                                            <p>
                                                <?php echo ' <b>กิตติกรรมการเดิน : </b>' . $cow_activity; ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="edible">
                                        ...
                                        <div class="content-edible">
                                            ...
                                            <p><b>วันให้นม :</b>
                                                <?php echo " " . number_format($milk_date, 0, '.', ''); ?>
                                                วัน
                                            </p>
                                            ...
                                            <p><b>อายุครรภ์ :</b>
                                                <?php echo " " . number_format($calf_date, 0, '.', ''); ?>
                                                วัน
                                            </p>
                                            <p>
                    ...
                    <div class="d-flex justify-content-center btn-more">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-add confirm"
                                name="calproductgroup">บันทึกข้อมูล</button>
                        </div>
                    </div>
                </form>
            </div>
