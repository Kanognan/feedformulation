                ...
                <div class="mt-4">
                    <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                        <li class="nav-item my-sm-1 my-2">
                            <a href="../raw/select_raw.php" class="nav-link text-white text-center text-sm-start menu-link" aria-current="page">
                        ...
                        <li class="nav-item my-sm-1 my-2">
                            <a href="feed.php" class="nav-link text-white text-center text-sm-start menu-link" aria-current="page">
                        ...
                        <hr class="text-white d-none d-sm-block hr-sidebar">
                        <li class="nav-item my-sm-1 my-2">
                            <a href="cost.php" class="nav-link text-white text-center text-sm-start menu-link" aria-current="page">
                        ...
                        <hr class="text-white d-none d-sm-block hr-sidebar">
                        <li class="nav-item my-sm-1 my-2">
                            <a href="index_profit.php" class="nav-link text-white text-center text-sm-start menu-link" aria-current="page">
                        ...
                        <hr class="text-white d-none d-sm-block hr-sidebar">
                        <li class="nav-item my-sm-1 my-2">
                            <a href="repair.php" class="nav-link text-white text-center text-sm-start menu-link" aria-current="page">
