...
<head>
    ...
    <title>คำนวณผลตอบแทนรายเดือน</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    @media (max-width: 576px) {
        .content {
            ...
            .col-md-2 {
                width: 100%;
                text-align: center;
                margin-bottom: 10px; /* เพิ่มระยะห่างด้านล่างเมื่อ responsive */
                margin-left: 1.5em; /* เพิ่มระยะห่างด้านล่างเมื่อ responsive */
            }
            /* .row>*{
            ...
            <div class="content">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-12 col-lg col-md-6 col-sm-12"><button type="button" onclick="window.location='r_monthy.php'"
                            class="cat-active">ผลตอบแทนรายเดือน</button> </div>
                ...
                <h3 class="text-center">ผลตอบแทนรายเดือน</h3><br>
                <!-- เนื้อหา -->
                <!-- ผลตอบแทนรายเดือน -->
                <div class="container">
                    <div class="row box1">
                        <form action="r_monthy.php" method="get" class=" row d-flex justify-content-center">
                            <div class="col-md-4 col-lg-3 col-12  mt-2">
                                <select name="start_month" class="form-control" id="start_month">
                                    ...
                                    <?php
                                        ...
                                        for ($i = 1; $i <= 12; $i++) {
                                            echo '<option value="' . $i . '">' . $thai_months[$i - 1] . '</option>';
                                        }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-2 col-12  mt-2">
                        ...
                        <div class="col-12">
                            <?php
                        if (isset($_GET['start_month']) && $_GET['end_month'] !== '') {
                            $query_chart = "SELECT *,
                            DATE_FORMAT(statement_date, '%M-%Y') AS statement_date,
                            ...
                            MONTH(statement_date)  BETWEEN '".$_GET['start_month']."' AND '".$_GET['end_month']."'
                            GROUP BY
                            DATE_FORMAT(statement_date, '%Y-%m')
                            ORDER BY
                            DATE_FORMAT(statement_date, '%Y-%m')";
                            ...
                            WHERE acc_id = $acc_id AND
                            MONTH(statement_date)  BETWEEN '".$_GET['start_month']."' AND '".$_GET['end_month']."'
                            GROUP BY DATE_FORMAT(statement_date, '%Y-%m')
                            ORDER BY DATE_FORMAT(statement_date, '%Y-%m')";
                        ?><br>
                            <p><b>ผลตอบแทนของวันที่ :</b> <?= $thai_months[$_GET['start_month'] - 1];?>
                                ถึง
                                <?= $thai_months[$_GET['end_month'] - 1];?>
                            </p>
                            <?php 
                        } else {
                        ...
                        <div class="col-12 mt-4">
                            <h3 class="text-center">รายละเอียดผลตอบแทนรายเดือน</h3><br>
                            <?php
                                ...
                                <table class="table " id="table" data-filter-control="true" data-toggle="table"
                                    ...
                                    <thead>
                                        <tr style='text-align:center;'>
                                            <th data-field="statement_date">ประจำเดือน</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            echo $thai_months[date('m', strtotime($row['statement_date']))];?></td>
                                            ...
                                            <td style='text-align:left;'>
                                                ...
                                                acc_id = $acc_id AND
                                                DATE_FORMAT(statement_date, '%M-%Y')   = '$date' 
