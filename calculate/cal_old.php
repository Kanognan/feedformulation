...
<body>
    ...
    <div class="top">
        <div class="tab">
            <button class="tablinks" onclick="opencal(event, 'feed')" id="defaultOpen">
                <i class="fa-solid fa-square-root-variable"></i> คำนวณสูตรอาหาร
            </button>
            <button class="tablinks" onclick="opencal(event, 'cost')"><i class="fa-solid fa-sack-dollar"></i>
                คำนวณต้นทุน</button>
            <button class="tablinks" onclick="opencal(event, 'profit')"><i class="fa-solid fa-chart-column"></i>
                คำนวณผลตอบแทน</button>
            <button class="tablinks" onclick="opencal(event, 'product')"><i class="fa-solid fa-chart-line"></i>
                คาดการณ์ผลผลิต</button>
            <button class="tablinks" onclick="opencal(event, 'repair')"><i class="fa-solid fa-sliders"></i>
                ปรับปรุงคุณภาพอาหาร</button>
        ...
        <div id="feed" class="tabcontent">
            ...
            <div class="main">
                ...
                <h2 class="h4">คำนวณสูตรอาหาร</h2>
                <div class="feed-cow">
                    <form action="cal.php" method="post">
                        <h4>คำนวณโภชนะของโค</h4>
                        <!-- อุณหภูมิ -->
                        <div class="row">
                            <div class="col-6">
                                    ...
                                    <table class="table table-bordered" style="font-family:'Kanit'; text-align:center;">
                                        ...
                                        <tbody>
                                            <tr style="background-color:white;">
                                                ...
                                                <td><?php echo number_format($PER_CPl, 1, '.', '') ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-bordered" style="font-family:'Kanit'; text-align:center;">
                                        ...
                                        <tbody>
                                            <tr style="background-color:white;">
                                                ...
                                                <td><?php echo number_format($PER_CPg, 1, '.', '') ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
    ...
    <div id="cost" class="tabcontent">
        <div class="main">
            <h4>คำนวณต้นทุน</h4><br>
            <form action="" method="post">
                <h5>ข้อมูลของโค</h5><br>
                <div class="row">
                    <div class="col-5">
                        <img src="../Images/sl4.png" style="width:90%;">
                    </div>
                    <div class="col-7">
                        <p><b>พันธุ์โคนม : </b>โฮลสไตน์ฟรีเชี่ยน</p>
                        <p><b>ชื่อ : </b>ปอนปอน <b>เบอร์โค : </b>324123</p>
                        <p><b>เพศ : </b>เมีย <b>อายุ : </b>6 เดือน <b>ระยะโครุ่น</b></p>
                        <p><b>น้ำหนัก : </b>259 กิโลกรัม</p>
                        <p><b>ความต้องการทางโภชนะ : </b></p>
                        <p class="indent"><b>%CP : </b>10.6 %</p>
                        <p class="indent"><b>Energy : </b>1,200</p>
                        <p><b>การกินได้ของโค : </b>14 กก./วัน</p>
                    </div>
                    <hr>
                    ...
                    <table class="table">
                        <thead>
                            <tr style="text-align:center;">
                                <th scope="col"></th>
                                <th scope="col-8">รายการ</th>
                                <th scope="col">ราคาต่อหน่วย</th>
                                <th scope="col">จำนวน(min)</th>
                                <th scope="col">จำนวน(max)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td><input class='amount' type="number" name="amount" id="amount"></td>
                                <td><input class='amount' type="number" name="amount" id="amount"></td>
                            </tr>
                            <tr>
                                <th scope="row">1</th>
                ...
                <div class="addcal">
                    <button type="submit" class="btn" id="cost">คำนวณ</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="profit" class="tabcontent">
        <div class="main">
            <h4 class="h4">คำนวณผลตอบแทน</h4><br>
            <form action="./cow/addcow.php" method="post">
                <div class="row" id="milk">
                    <div class="col-6 milk">
                        <input type="radio" class="btn-check" name="options-outlined" id="success-outlined"
                            autocomplete="off" checked>
                        <label class="btn btn-outline-success" for="success-outlined" id="year">คำนวณแบบรายเดือน</label>
                    </div>
                    <div class="col-6 milk">
                        <input type="radio" class="btn-check" name="options-outlined" id="danger-outlined"
                            autocomplete="off">
                        <label class="btn btn-outline-success" for="danger-outlined"
                            id="year">คำนวณแบบรายสัปดาห์</label>
                ...
                <a href="../cow/addcow.php">
                    <div class="no-cow">ยังไม่มีข้อมูลโค</div>
                </a><br>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">การกินได้ของโค
                        (กิโลกรัม/วัน)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="12.45">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">ปริมาณน้ำนมต่อวัน
                        (กิโลกรัม)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="50.56">
                </div>
                <div class="addcal"><button type="sumbit" class="btn" id="prof">คำนวณ</button></div>
            </form>
        </div>
    </div>
    <div id="product" class="tabcontent">
        <div class="main">
            <h4 class="h4">คาดการณ์ผลผลิต</h4>
    ...
    <div id="repair" class="tabcontent">
        <div class="main">
            <h4 class="h4">ปรับปรุงคุณภาพอาหาร</h4>
