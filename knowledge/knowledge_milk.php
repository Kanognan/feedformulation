...
<body>
    ...
    <h2 class="text-center pt-3">ความรู้ / เทคนิคราคานมโค</h2>
        ...
        <div class="row">
            ...
            if (isset ($_GET['search'])) {
                ...
                $query = mysqli_query($conn, "SELECT k.*, c.category_knowledge_name 
                    ...
                    JOIN category_knowledge c 
                    ON k.category_knowledge_id = c.category_knowledge_id 
                    WHERE k.category_knowledge_id = '4'");
            }
            ...
            <?php }
                ...
                echo '<p class="text-center">ไม่พบข้อมูลความรู้ / เทคนิคราคานมโค</p>';
            }
            ?>
        </div>
    </div>
