                ...
                <div class="container">
                    <ul class="nav nav-tabs nav-select nav-pills nav-fill" id="myRaw" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active text-black fs-5" id="add-raw" data-bs-toggle="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-black fs-5" id="my-raw" data-bs-toggle="tab"
                            ...
                            <div>
                                ...
                                <form method="POST" action="select_raw_db.php" id="myForm">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label for="namedetail"
                                                        class="form-label fs-5 fw-medium">ชื่อกลุ่มวัตถุดิบ</label>
                                                    <div class="form-floating">
                                                        <textarea class="form-control"
                                                            placeholder="กรอกชื่อคลังการวัตถุดิบ" id="namedetail"
                                                            name="namedetail" required></textarea>
                                                        <label for="namedetail"
                                                ...
                                                <div class="col">
                                                    <label for="nameRaw"
                                                        class="form-label fs-5 fw-medium">รายละเอียดกลุ่มวัตถุดิบ</label>
                                                    <div class="form-floating">
                                                        <textarea class="form-control"
                                                            placeholder="กรอกรายละเอียดรายการวัตถุดิบ" id="detailRaw"
                                                            name="detailRaw"></textarea>
                                                        <label for="detailRaw"
                                    ...
                                    <div class="raw mt-5 box">
                                        ...
                                        <div class="selectRaw">
                                            <label for="selectRaw"
                                                class="form-label fs-5 fw-medium">เลือกวัตถุดิบ</label>
                                    ...
                                    <div class="mineral mt-5 box">
                                        ...
                                        <div class="selectMineral">
                                            <label for="selectMineral"
                                                class="form-label fs-5 fw-medium">เลือกแร่ธาตุและวิตามิน</label>
