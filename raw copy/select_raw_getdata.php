...
$sqlGroups = "SELECT DISTINCT raw_group_id, group_name, group_description, DATE(createAt) as createAt, DATE(updateAt) as updateAt FROM raw_group WHERE acc_id = $acc_id ORDER BY raw_group_id";
