            ...
            <form method="POST" action="select_raw_editdb.php" id="myForm">
                ...
                <div class="details">
                    ...
                    <div class="detail">
                        <div class="row">
                            <div class="col">
                                <label for="namedetail" class="form-label fs-5 fw-medium">ชื่อรายการวัตถุดิบ</label>
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="กรอกชื่อรายการวัตถุดิบ" id="namedetail"
                                        name="namedetail" required><?php echo $group['group_name'] ?></textarea>
                                    <label for="namedetail" class="text-secondary">กรอกชื่อรายการวัตถุดิบ</label>
                                </div>
                            </div>
                            <div class="col">
                                <label for="nameRaw" class="form-label fs-5 fw-medium">รายละเอียดรายการวัตถุดิบ</label>
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="กรอกรายละเอียดรายการวัตถุดิบ"
                                        id="detailRaw"
                                        name="detailRaw"><?php echo $group['group_description']; ?></textarea>
                                    <label for="detailRaw" class="text-secondary">กรอกรายละเอียดรายการวัตถุดิบ</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group d-flex justify-content-center mt-5 mb-5 sentbtn">
                    <button type="reset" class="btn btn-danger btn-reset" onclick="window.location.href = 'select_raw.php'">ย้อนกลับ</button>
