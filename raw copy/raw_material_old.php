                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="paddingSide">
                            ...
                            <div class="collapse show" id="submenu1">
                                <ul class="nav flex-cocollapselumn ms-1">
                                    <li>
                                    ...
                                    <li>
                                        <a href="#submenu5" data-bs-toggle="collapse" data-bs-target="#menu5"
                                            class="nav-link no-p px-0 align-middle sidenav">
                                            <span class="ms-1 d-none d-sm-inline">กรดอะมิโนในวัตถุดิบ</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            <a href="#menu6" data-bs-toggle="collapse" class="nav-link no-p px-0 align-middle sidenav">
                                <i class="fa-solid fa-file-circle-plus"></i>
                                <span class="ms-1 d-none d-sm-inline">ค่าแร่ธาตุ</span>
                                <i class="bi bi-chevron-down"></i>
                            </a>
                            <div class="collapse" id="menu6">
                                <ul class="nav flex-column ms-1">
                                    <li>
                                        <a href="#submenu6-2" data-bs-toggle="collapse" data-bs-target="#menu6-2"
                                            class="nav-link no-p px-0 align-middle sidenav">
