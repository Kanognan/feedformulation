...
<body>
    ...
    <div class="container">
        ...
        <div class="form_add">
            ...
            <form class="" action="minerals_detail.php" method="post" enctype="multipart/form-data" id="myForm">
                <div class="row t1-1 t22">
                    <?php
                    $sqlRawThai = "SELECT * FROM raw_material";
                        ...
                        <table class="table table-bordered was-validated">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="data4-1-1" name="dminer_per_ca_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-1-2" name="dminer_per_ca_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-1-3" name="dminer_per_ca_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td rowspan="6" class="text-center">%</td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่าฟอสฟอรัส (P)</th>
                                    <td><input type="text" class="form-control" id="data4-2-1" name="dminer_per_p_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-2-2" name="dminer_per_p_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-2-3" name="dminer_per_p_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่าแมกนีเซียม (Mg)</th>
                                    <td><input type="text" class="form-control" id="data4-3-1" name="dminer_per_mg_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-3-2" name="dminer_per_mg_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-3-3" name="dminer_per_mg_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่าโพแทสเซียม (K)</th>
                                    <td><input type="text" class="form-control" id="data4-4-1" name="dminer_per_k_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-4-2" name="dminer_per_k_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-4-3" name="dminer_per_k_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่ากำมะถัน (S)</th>
                                    <td><input type="text" class="form-control" id="data4-5-1" name="dminer_per_s_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-5-2" name="dminer_per_s_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-5-3" name="dminer_per_s_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่าโซเดียม (Na)</th>
                                    <td><input type="text" class="form-control" id="data4-6-1" name="dminer_per_na_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-6-2" name="dminer_per_na_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-6-3" name="dminer_per_na_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                            </tbody>
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="data4-7-1" name="dminer_kg_cu_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-7-2" name="dminer_kg_cu_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-7-3" name="dminer_kg_cu_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td rowspan="4" class="text-center">mg/kg</td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่าเหล็ก (Fe)</th>
                                    <td><input type="text" class="form-control" id="data4-8-1" name="dminer_kg_fe_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-8-2" name="dminer_kg_fe_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-8-3" name="dminer_kg_fe_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่าแมงกานีส (Mn)</th>
                                    <td><input type="text" class="form-control" id="data4-9-1" name="dminer_kg_mn_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-9-2" name="dminer_kg_mn_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-9-3" name="dminer_kg_mn_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">ค่าสังกะสี (Zn)</th>
                                    <td><input type="text" class="form-control" id="data4-10-1" name="dminer_kg_zn_avg" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-10-2" name="dminer_kg_zn_sd" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                    <td><input type="text" class="form-control" id="data4-10-3" name="dminer_kg_zn_n" required pattern="(?:nd|Nd|ND|\d+(\.\d+)?)">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
