...
<head>
    ...
    <title>แก้ไขรายการวัตถุดิบ</title>
...
<body>
        ...
        <div class="menu-add">
            <div class="d-flex justify-content-center">
                <div class="row text-center">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <button type="button" class="select-add btn btn-light add"
                            onclick="window.location='edit_source_minerals.php'">จัดการค่าแร่ธาตุและวิตามิน</button>
                    </div>
                </div>
            </div>
        </div>
        <h1 class="mt-5 text-center">จัดการกรดอะมิโนในวัตถุดิบ</h1>
        <?php
        $sqltab3 = "SELECT 
                        raw_material.raw_id, 
                                ...
                                <div class="row p-2 text-center d-flex justify-content-center">
                                    <div>
                                        <button class="btn btn-warning mb-2" style="width: 3em;"
                                            onclick="window.location.href='material_edit.php?id=<?php echo $rowtab3['raw_id']; ?>'">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-danger" style="width: 3em;"
                                            ...
                                            data-bs-target="#ModalDeleteRaw3<?php echo $rowtab3['raw_id']; ?>"
    ...
    <?php
    if (isset ($_SESSION['resultDataEditRaw'])) {
        $resultDataEditRaw = $_SESSION['resultDataEditRaw'];
        echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        icon: 'success',
                        title: 'อัพเดตข้อมูลสำเร็จ',
                        text: '" . $resultDataEditRaw . "',
        ...
        unset($_SESSION['resultDataEditRaw']);
    }
    ?>
    <?php
    ...
    ?>
    <?php
    if (isset ($_SESSION['resultDeleteRaw'])) {
        $resultDeleteRaw = $_SESSION['resultDeleteRaw'];
        echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        icon: 'success',
                        title: 'ลบรายการวัตถุดิบสำเร็จ',
                        text: '" . $resultDeleteRaw . "',
                        confirmButtonText: 'OK',
                        showConfirmButton: false,
                        timer: 2000 
                    });
        ...
        unset($_SESSION['resultDeleteRaw']);
    }
    ?>
