...
<body>
    ...
    <div class="container">
        ...
        <div class="form_add">
            <h1>เพิ่มค่าแร่ธาตุและวิตามิน</h1>
            <form class="container" action="source_minerals.php" method="post" enctype="multipart/form-data"
                ...
                <div class="" id="general-information" role="tabpanel" aria-labelledby="general-information-tab"
                    ...
                    <div class="row t1-1 t22">
                        <?php
                        $sqlRawThai = "SELECT * FROM mineral_source_raw ISNULL(mineral_source_raw.deleteAt)";
