...
if (isset($_POST['saveChanges'])) {
    ...
    $sqlUpdate2 = "UPDATE user
        SET user_fname='$user_fname', user_lname='$user_lname', user_gender='$user_gender', user_bdate='$user_bdate', user_phone='$user_phone', career_id='$career_id', updateAt='$updateAt' 
        WHERE acc_id = '$id'";
