...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search = $_GET['search'];
    $search_query = "SELECT * FROM posts WHERE category_id = '1' AND posts_name LIKE '%$search%' AND deleteAt IS NULL ORDER BY postsID DESC";
...
<body>
    ...
    <div class="container">
        ...
        <div class="content-posts">
            <h2 class="h2-title text-center">การเลี้ยงโค</h2>
            <?php
