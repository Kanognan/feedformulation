...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search = $_GET['search'];
    $search_query = "SELECT * FROM posts WHERE category_id = '2' AND posts_name LIKE '%$search%' AND deleteAt IS NULL ORDER BY postsID DESC";
    $result_posts = $conn->query($search_query);
} else {
    $ID1 = "SELECT * FROM posts WHERE category_id = '2' AND deleteAt IS NULL ORDER BY postsID DESC";
...
<body>
    ...
    <div class="container">
        ...
        <div class="content-posts">
            <h2 class="h2-title text-center">การรีดนม</h2>
            <?php
