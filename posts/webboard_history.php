...
<body>
                ...
                <div class="h2-title">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 d-flex justify-content-end">
                            <form id="deletePostForm" action="delete_post.php" method="post">
                                <div class="col justify-content-center">
                                    <input type="hidden" name="postsID" id="postsID"
                                        value="<?php echo $result['postsID']; ?>">
                                    <button type="button" class="btn btn-warning ms-1" id="editPost"
                                        onclick="window.location='mypost_edit.php?id=<?php echo $result['postsID']; ?>'"><i
                                            class="bi bi-pencil-square"></i></button>
                                    <button type="submit" class="btn btn-danger ms-1" id="deletePost"><i
                            ...
                            <form action="comment-webboard.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="text-center">
                                    <button type="reset" class="btn btn-danger"
                                        onclick="window.location='webboard_history.php?id=<?php echo $result['postsID']; ?>'">ยกเลิก</button>
    ...
    <script>
        document.getElementById('deletePost').addEventListener('click', function (event) {
            event.preventDefault(); // ป้องกันการ redirect หน้าเว็บ
            Swal.fire({
                title: 'ยืนยันการลบ',
                ...
                if (result.isConfirmed) {
                    document.getElementById('deletePostForm').submit(); // ทำการ submit form
                }
            });
        });
    </script>
