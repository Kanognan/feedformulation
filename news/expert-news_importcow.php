...
<?php include "nav-bar.php"
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center addnews">
            <h3 class="ml-5">นำเข้า/ส่งออกโคนม</h3>
        ...
        <?php
        $num = 0;
        $ID6 = "SELECT * FROM news  WHERE category_news_id= '6'";
        $resultID6 = $conn->query($ID6);
        ...
        <div class="content-news">
            <table class="table" id="table" data-filter-control="true" data-toggle="table"
                ...
                <?php
                if ($resultID6 && $resultID6->num_rows > 0) {
                    foreach ($resultID6 as $result) {
                        ...
                        <td class="text-center">
                            <div onclick="window.location='edit_news.php?news_id=<?php echo $row['news_id']; ?>'"
