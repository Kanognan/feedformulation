...
<body>
    ...
    <div class="container">
        ...
        <?php
        $num = 0;
        $ID1 = "SELECT * FROM news  WHERE category_news_id= '1'";
...
?>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#del<?php echo $news_id; ?>">
                            <span class="glyphicon glyphicon-trash"></span>
                            <img src="../pic/delete.png" alt="" style="width:15px; height:15px; margin-right:5px">
                        </button>
                        <div class="modal fade" id="del<?php echo $news_id; ?>" tabindex="-1" role="dialog"
                            aria-labelledby="del" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="del<?php echo $news_id; ?>">
                                    ...
                                    <div class="modal-body">
                                        <?php
                                $del = mysqli_query($conn, "SELECT * FROM news WHERE news_id='$news_id'");
                                ...
                                ?>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="delete.php?news_id=<?php echo $news_id; ?>" class="btn btn-danger">
                ...
                <?php
                    ...
                    echo "<tr><td colspan='4' class='mt-5'>ไม่มีข้อมูล</td></tr>";
                }
                ?>
                </tbody>
            </table>
