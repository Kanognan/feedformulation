...
<body>
    ...
    <div class="container">
        ...
        <div class="content-news">
            <?php
            $num = 0;
            $sql = "SELECT * FROM news inner join category_news on news.category_news_id = category_news.category_news_id ORDER BY createAt DESC";
            ...
            <table class="table" id="table" data-filter-control="true" data-toggle="table"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="truncate"><?php echo $row['news_topic'] ?></p>
                        </td>
                        <td class="text-center">
                            <?php echo $row['category_news_name'] ?>
                        </td>
                        <td class="text-center">
                            <?php  echo date("d-m-Y H:i:s", strtotime($row["createAt"]));  ?>
                        </td>
                        <td class="text-center">
                        <div onclick="window.location='edit_news.php?news_id=<?php echo $news_id; ?>'"
                            data-toggle="modal" class="btn btn-warning">
                            <span class="glyphicon glyphicon-edit"></span>
                            <img src="../pic/edit.png" alt="" style="width:15px; height:15px; margin:5px" title="แก้ไขข้อมูลโค">
                        </div>
