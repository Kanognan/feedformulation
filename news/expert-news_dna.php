...
<head>
    ...
    <title>ข่าวสารสายพันธุ์/พันธุกรรม</title>
    <style>
    * {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center addnews">
            <h3 class="ml-5">พันธุกรรม/สายพันธุ์</h3>
        ...
        <?php
        $num = 0;
        $ID3 = "SELECT * FROM news  WHERE category_news_id= '3'";
        $resultID3 = $conn->query($ID3);
        ?>
        <!----------------------------------------------------------------->
        <div class="content-news">
            <table class="table" id="table" data-filter-control="true" data-toggle="table" data-pagination="true"
                data-locale="th-TH" data-flat="true" data-icons="icons" data-toggle="table" data-search="true"
                ...
                <tbody>
                    <?php
            if ($resultID3 && $resultID3->num_rows > 0) {
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo $result['news_topic'] ?></td>
                        <td class="text-center"><?php echo date("d-m-Y H:i:s", strtotime($result["createAt"])); ?></td>
                        <td class="text-center">
                            <div onclick="window.location='edit_news.php?news_id=<?php echo $news_id; ?>'"
                                class="btn btn-warning">
                                <img src="../pic/edit.png" alt="" style="width:15px; height:15px; margin:5px"
                                    title="แก้ไขข้อมูลโค">
                            </div>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#del<?php echo $result['news_id']; ?>">
                                <img src="../pic/delete.png" alt="" style="width:15px; height:15px; margin-right:5px">
                            </button>

                            <div class="modal fade" id="del<?php echo $result['news_id']; ?>" tabindex="-1"
                                role="dialog" aria-labelledby="del" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="del<?php echo $result['news_id']; ?>">
                                        ...
                                        <div class="modal-body">
                                            <?php
                                        $del = mysqli_query($conn, "select * from news where news_id='" . $result['news_id'] . "'");
