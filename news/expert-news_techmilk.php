...
<head>
    ...
    <title>ข่าวสารงานวิจัยและเทคโนโลยี</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<?php include "nav-bar.php"
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center addnews">
            <h3 class="ml-5">งานวิจัยและเทคโนโลยี</h3>
        ...
        <?php
        $num = 0;
        $ID2 = "SELECT * FROM news  WHERE category_news_id= '2'";
    ...
    <tbody>
        <?php
        if ($resultID2 && $resultID2->num_rows > 0) {
