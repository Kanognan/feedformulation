...
<head>
  ...
  <link rel="shortcut icon" href="../Images/logofeeds.ico">
    ...
    <title>ข่าวสารโรคระบาดในโคนม</title>
    <style>
    * {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center addnews">
            <h3 class="ml-5">โรคระบาดในโคนม</h3>
        ...
        <?php
        $num = 0;
        $ID5 = "SELECT * FROM news  WHERE category_news_id= '5'";
        $resultID5 = $conn->query($ID5);
        ...
        <div class="content-news">
            <table class="table" id="table" data-filter-control="true" data-toggle="table" data-pagination="true"
                ...
                <?php
                if ($resultID5 && $resultID5->num_rows > 0) {
                    foreach ($resultID5 as $result) {
