...
function page_navi($total_item, $cur_page, $per_page = 10, $query_str = "", $min_page = 5)
{
    ...
    echo '<nav style="background-color: #fff; width:93.5%; margin: 0 auto;">
      <ul class="pagination justify-content-center" style="background-color: #fff; ">
        <li class="page-item" >
        <a class="page-link" style="color: #4f80c0; " href="' . $query_str . $mark_char . 'page=1"> หน้าแรก</a>
        </li>
        ';
    echo '
    ...
    echo '
        <li class="page-item"> 
            <a class="page-link"  style="color: #4f80c0; " href="' . $query_str . $mark_char . 'page=' . $total_page . '"> หน้าสุดท้าย</a> 
        </li>     
      </ul>
    </nav>        
    ';
